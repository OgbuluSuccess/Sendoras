    ...
    <section className="lp-features" id="features">
      <div className="lp-section-inner">
        <div className="lp-section-header">
          <span className="lp-section-tag">Why {APP_NAME}</span>
          ...
          <p className="lp-section-sub">
            Built for developers and marketers who can't afford deliverability
        ...
        <div className="lp-features-grid">
          {features.map((f) => (
            <div
              key={f.title}
              className={`lp-feature-card${f.featured ? " featured" : ""}`}
            >
              <div className="lp-feature-icon-wrap">{f.icon}</div>
              <h3>{f.title}</h3>
              <p>{f.desc}</p>
              <a href="#" className="lp-feature-link">
                Learn more →
              </a>
            </div>
          ))}
