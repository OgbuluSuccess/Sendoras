            ...
            <div className="lp-hero-inner">
                ...
                <div className="lp-hero-text">
                    ...
                    <p className="lp-hero-sub">
                        Sendora is the email infrastructure built for marketers and developers.
                        Upload your lists, craft personalized campaigns, and send at scale —
                        with real-time analytics to back every decision.
                    </p>
                    ...
                    <div className="lp-hero-social-proof">
                        ...
                        <p className="lp-proof-text">
                            Trusted by <strong>500+ teams</strong> to deliver over 20M emails monthly
                        </p>
                    </div>
                </div>
                ...
                <div className="lp-hero-visual">
                    ...
                    <div className="lp-hero-card">
                        <div className="lp-hero-card-topbar">
                            ...
                            <span className="lp-card-bar-title">sendora.io/dashboard</span>
                        </div>
                        <div className="lp-hero-card-body">
                            ...
                            <div className="lp-mock-bar-row">
                                <div className="lp-mock-bar-item">
                                    ...
                                    <div className="lp-mock-bar-track">
                                        <div className="lp-mock-bar-fill" style={{ width: '68%' }}></div>
                                    </div>
                                    <span>68%</span>
                                </div>
                                <div className="lp-mock-bar-item">
                                    ...
                                    <div className="lp-mock-bar-track">
                                        <div className="lp-mock-bar-fill" style={{ width: '45%', background: '#10b981' }}></div>
                                    </div>
                                    <span>45%</span>
                                </div>
                                <div className="lp-mock-bar-item">
                                    ...
                                    <div className="lp-mock-bar-track">
                                        <div className="lp-mock-bar-fill" style={{ width: '3%', background: '#ef4444' }}></div>
                                    </div>
                                    <span>3%</span>
                                </div>
                            </div>
                            ...
                            <div className="lp-mock-campaign-row">
                                <div>
                                    ...
                                    <div className="lp-mock-camp-sub">8,200 recipients · 2h ago</div>
                                </div>
                            ...
                            <div className="lp-mock-campaign-row">
                                <div>
                                    ...
                                    <div className="lp-mock-camp-sub">24,550 recipients · Yesterday</div>
                                </div>
                                <span className="lp-mock-camp-badge">Sent ✓</span>
                            </div>
                        </div>
