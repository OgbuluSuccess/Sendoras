    ...
    <div className="lp-trust">
        <div className="lp-trust-inner">
            ...
            <div className="lp-trust-logos">
                {['Acme Corp', 'LaunchBase', 'Growthly', 'Nexus HQ', 'Vantex'].map(name => (
                    <span key={name} className="lp-trust-name">{name}</span>
                ))}
            </div>
        </div>
    </div>
    ...
    <section className="lp-steps" id="how-it-works">
        <div className="lp-section-inner">
            <div className="lp-section-header">
                ...
                <h2 className="lp-section-title">From list to inbox<br />in three steps</h2>
        ...
        <div className="lp-footer-inner">
            <div className="lp-footer-top">
                <div className="lp-footer-brand">
                    <div className="lp-logo" style={{ display: 'flex', alignItems: 'center', gap: '0.5rem', marginBottom: '0.75rem' }}>
                        <Mail size={18} style={{ color: 'var(--lp-primary)' }} />
                        <span style={{ color: '#fff', fontWeight: 800 }}>Sendora</span>
                    </div>
                    <p>Email infrastructure built for scale. Send smarter, reach every inbox.</p>
                </div>
            ...
            <div className="lp-footer-bottom">
                <span>© {new Date().getFullYear()} Sendora. All rights reserved.</span>
