...
const RecordRow = ({ type, name, value, ttl = "Auto" }) => (
  <tr style={{ borderBottom: "1px solid #f1f5f9" }}>
    <td style={{ padding: "0.65rem 0.75rem", width: "80px" }}>
      <span
        style={{
          background: type === "TXT" ? "#fef3c7" : "#e0e7ff",
          color: type === "TXT" ? "#92400e" : "#3730a3",
    ...
    >
      ...
      >
        <span>{value}</span>
        <button
          onClick={() => copyToClipboard(value, `${type} record`)}
          style={{
            background: "none",
            border: "none",
            cursor: "pointer",
              ...
              {[
                {
                  ...
                  desc: "Receive a summary email after each campaign is sent.",
                },
                {
                  key: "billing",
                  label: "Billing Alerts",
                  desc: "Get notified about invoices and plan changes.",
                },
                {
                  key: "product",
                  label: "Product Updates",
                  desc: "Stay updated with new features and changelogs.",
                },
              ].map((n) => (
                <div
                  key={n.key}
                  ...
                  >
                    ...
                    <span
                      style={{
                        position: "absolute",
                        inset: 0,
                        background: notifs[n.key] ? "#f97316" : "#e2e8f0",
                        borderRadius: 999,
