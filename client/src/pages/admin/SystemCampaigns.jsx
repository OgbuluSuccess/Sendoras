...
const SystemCampaigns = () => {
  ...
  const copyFailedEmails = () => {
    ...
    const failed = detail.recipients
  ...
  const sentCountR = (detail?.recipients || []).filter(
    (r) => r.status === "sent",
  ).length;
  const failedCountR = (detail?.recipients || []).filter(
    (r) => r.status === "failed",
  ).length;
          ...
          <div style={{ overflowY: "auto", flex: 1 }}>
            ...
            >
              ...
              >
                <div
                  style={{
                    width: `${total ? (sentCount / total) * 100 : 0}%`,
                ...
                <div
                  style={{
                    width: `${total ? (failedCount / total) * 100 : 0}%`,
              ...
              >
                <span>
                  {sentCount + failedCount} of {total} processed
                </span>
                {failedCount > 0 && (
                  <button
              ...
              {failedCount > 0 && !detail?.failureReason && (
                ...
                >
                  ...
                  <span style={{ fontSize: "0.7rem", color: "#991b1b" }}>
                    {failedCount} email(s) failed. No error detail was captured
                    — this usually means the email queue (Redis/BullMQ) was
                    offline when the campaign ran.
                  </span>
                </div>
              )}
            </div>
            ...
            >
              <div style={{ display: "flex", gap: "0.5rem" }}>
                <span style={{ color: "#94a3b8", minWidth: 55 }}>Subject</span>
                <span
                  style={{
                    color: "#0f172a",
                    fontWeight: 500,
              ...
              <div style={{ display: "flex", gap: "0.5rem" }}>
                <span style={{ color: "#94a3b8", minWidth: 55 }}>Sender</span>
                <span
                  style={{
                    color: "#0f172a",
                    fontWeight: 500,
              ...
              >
                <span style={{ color: "#94a3b8", minWidth: 55 }}>Source</span>
                <span
                  style={{
                    fontSize: "0.68rem",
                    fontWeight: 600,
                    ...
                    borderRadius: "4px",
                    background: detail.source === "api" ? "#e0e7ff" : "#f1f5f9",
                    color: detail.source === "api" ? "#4f46e5" : "#64748b",
                  }}
                >
                  {detail.source === "api" ? "API" : "Dashboard"}
                </span>
              </div>
              <div
                style={{ display: "flex", gap: "0.5rem", alignItems: "center" }}
              >
                <span style={{ color: "#94a3b8", minWidth: 55 }}>Status</span>
                <span
                  className={`d-badge ${statusColors[detail.status?.toLowerCase()] || "d-badge-neutral"}`}
                ...
                {[
                  ...
                  <button
                    ...
                    style={{
                      ...
                      cursor: "pointer",
                      fontWeight: 600,
                      background: emailFilter === f.key ? "#0f172a" : "#f1f5f9",
                      color: emailFilter === f.key ? "#fff" : "#64748b",
                        ...
                        background:
                          r.status === "failed"
                            ...
                            : r.status === "queued"
                              ...
                              : "#f0fdf9",
                        borderRadius: "10px",
                        border: `1px solid ${r.status === "failed" ? "#fecaca" : r.status === "queued" ? "#fde68a" : "#bbf7d0"}`,
                      }}
                    >
                      <div
                        style={{
                      ...
                      >
                        ...
                        >
                          ...
                          {r.timestamp && (
                            <div
                              style={{ color: "#94a3b8", marginTop: "0.1rem" }}
                            >
      ...
      <div style={{ flex: 1, minWidth: 0 }}>
        <div className="d-page-header">
          <div>
            ...
            <p>
              All campaigns across all accounts. {isMobile ? "Tap" : "Click"} a
              row to inspect delivery.
            </p>
          </div>
        </div>
                ...
                return (
                  ...
                  >
                    ...
                    <div style={{ flex: 1, minWidth: 0 }}>
                      ...
                      >
                        <span
                          className={`d-badge ${statusColors[c.status?.toLowerCase()] || "d-badge-neutral"}`}
                        ...
                        <span
                          style={{
                            ...
                            borderRadius: "4px",
                            background:
                              c.source === "api" ? "#e0e7ff" : "#f1f5f9",
                            color: c.source === "api" ? "#4f46e5" : "#64748b",
                            fontWeight: 600,
                          }}
                        >
                          {c.source === "api" ? "API" : "UI"}
                ...
                {paginatedCampaigns.map((c) => {
                  ...
                  return (
                    <tr
                      ...
                      className={`d-tr-hover${selectedCampaign?._id === c._id ? " active" : ""}`}
                    >
                      <td>
