...
const UserManagement = () => {
    ...
    const askConfirm = (type, id, label) => setConfirm({ open: true, type, id, label });
                        ...
                        <tbody>
                            {paginatedUsers.map(u => (
                                <tr key={u._id}>
                                    ...
                                    <td>
                                        <span className={`d-badge ${u.role === 'admin' ? 'd-badge-danger' : 'd-badge-neutral'}`}>
                                            {u.role}
                                        </span>
                                    </td>
                                    <td>
                                        <select
                                            ...
                                            style={{ padding: '0.3rem 0.6rem', borderRadius: 8, border: '1px solid #e2e8f0', fontSize: '0.82rem', cursor: 'pointer' }}
                                        >
                                            {TIER_OPTIONS.map(t => (
                                    ...
                                    <td>
                                        <div style={{ display: 'flex', gap: '0.5rem' }}>
                                            ...
                                            >
                                                {u.role === 'admin' ? <><User size={13} /> Demote</> : <><Shield size={13} /> Make Admin</>}
                                            </button>
                                            <button
