# Sendhiiv Trailer — Remotion Video Recorder

Records the live Sendhiiv app as a programmatically rendered MP4 video in both desktop and mobile formats.

## Prerequisites

1. **Sendhiiv must be running**:
...
- `out/sendhiiv-desktop.mp4`
- `out/sendhiiv-mobile.mp4`
