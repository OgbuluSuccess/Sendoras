...
// The token is injected into the Sendhiiv app via a ?__token= URL query param.
// main.jsx in the Sendhiiv client reads that param and stores it in localStorage.
export const AppFrame: React.FC<AppFrameProps> = ({
  ...
  // main.jsx in the Sendhiiv client reads __token + __user from the URL
    ...
    <div style={containerStyle}>
      <div style={phoneBezelStyle}>
        <iframe
          src={iframeSrc}
          style={iframeStyle}
          title={`Sendhiiv — ${currentPage.label}`}
